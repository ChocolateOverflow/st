...
static char *copyurlcmd[] = { "/bin/sh", "-c", "sed 's/.*│//g' | tr -d '\n' | grep -aEo '(((http|https)://|www\\.)[a-zA-Z0-9.]*[:]?[a-zA-Z0-9./&%?$#=_-]*)|((magnet:\\?xt=urn:btih:)[a-zA-Z0-9]*)' | uniq | sed 's/^www./https:\\/\\/www\\./g' | dmenu -i -p 'Copy which url?' -l 10 | tr -d '\n' | xclip -selection clipboard", "externalpipe", NULL };
...
static Shortcut shortcuts[] = {
	...
	{ ALT,					XK_equal,			zoom,           {.f = +1} },
	{ ALT,					XK_minus,			zoom,           {.f = -1} },
	{ ALT,					XK_0,					zoomreset,      {.f =  0} },
	...
	{ ALT,			      XK_l,					kscrollup,      {.i = -1} },
	{ ALT,			      XK_h,					kscrolldown,    {.i = -1} },
	{ ALT,			      XK_Page_Up,			kscrollup,      {.i = -1} },
	{ ALT,			      XK_Page_Down,		kscrolldown,    {.i = -1} },
	{ ALT,					XK_u,					externalpipe,   {.v = copyurlcmd } },
...
static Key key[] = {
	...
	{ XK_KP_End,			CTRL,					"\033[J",			-1,		 0},
	{ XK_KP_End,			CTRL,					"\033[1;5F",		+1,		 0},
	...
	{ XK_KP_Insert,		CTRL,					"\033[L",			-1,		 0},
	{ XK_KP_Insert,		CTRL,					"\033[2;5~",		+1,		 0},
	{ XK_KP_Insert,		XK_ANY_MOD,			"\033[4h",			-1,		 0},
	{ XK_KP_Insert,		XK_ANY_MOD,			"\033[2~",			+1,		 0},
	{ XK_KP_Delete,		CTRL,					"\033[M",			-1,		 0},
	{ XK_KP_Delete,		CTRL,					"\033[3;5~",		+1,		 0},
	...
	{ XK_Up,					CTRL,					"\033[1;5A",		 0,		 0},
	{ XK_Up,					SHIFT|CTRL,			"\033[1;6A",		 0,		 0},
	{ XK_Up,					CTRL|ALT,			"\033[1;7A",		 0,		 0},
	{ XK_Up,					SHIFT|CTRL|ALT,	"\033[1;8A",		 0,		 0},
	{ XK_Up,					XK_ANY_MOD,			"\033[A",			 0,		-1},
	{ XK_Up,					XK_ANY_MOD,			"\033OA",			 0,		+1},
	{ XK_Down,				SHIFT,				"\033[1;2B",		 0,		 0},
	{ XK_Down,				ALT,					"\033[1;3B",		 0,		 0},
	{ XK_Down,				SHIFT|ALT,			"\033[1;4B",		 0,		 0},
	{ XK_Down,				CTRL,					"\033[1;5B",		 0,		 0},
	{ XK_Down,				SHIFT|CTRL,			"\033[1;6B",		 0,		 0},
	{ XK_Down,				CTRL|ALT,			"\033[1;7B",		 0,		 0},
	{ XK_Down,				SHIFT|CTRL|ALT,	"\033[1;8B",		 0,		 0},
	{ XK_Down,				XK_ANY_MOD,			"\033[B",			 0,		-1},
	{ XK_Down,				XK_ANY_MOD,			"\033OB",			 0,		+1},
	{ XK_Left,				SHIFT,				"\033[1;2D",		 0,		 0},
	{ XK_Left,				ALT,					"\033[1;3D",		 0,		 0},
	{ XK_Left,				SHIFT|ALT,			"\033[1;4D",		 0,		 0},
	{ XK_Left,				CTRL,					"\033[1;5D",		 0,		 0},
	{ XK_Left,				SHIFT|CTRL,			"\033[1;6D",		 0,		 0},
	{ XK_Left,				CTRL|ALT,			"\033[1;7D",		 0,		 0},
	{ XK_Left,				SHIFT|CTRL|ALT,	"\033[1;8D",		 0,		 0},
	{ XK_Left,				XK_ANY_MOD,			"\033[D",			 0,		-1},
	{ XK_Left,				XK_ANY_MOD,			"\033OD",			 0,		+1},
	{ XK_Right,				SHIFT,				"\033[1;2C",		 0,		 0},
	{ XK_Right,				ALT,					"\033[1;3C",		 0,		 0},
	{ XK_Right,				SHIFT|ALT,			"\033[1;4C",		 0,		 0},
	{ XK_Right,				CTRL,					"\033[1;5C",		 0,		 0},
	{ XK_Right,				SHIFT|CTRL,			"\033[1;6C",		 0,		 0},
	{ XK_Right,				CTRL|ALT,			"\033[1;7C",		 0,		 0},
	{ XK_Right,				SHIFT|CTRL|ALT,	"\033[1;8C",		 0,		 0},
	...
	{ XK_Insert,			CTRL,					"\033[L",			-1,		 0},
	{ XK_Insert,			CTRL,					"\033[2;5~",		+1,		 0},
	{ XK_Insert,			XK_ANY_MOD,			"\033[4h",			-1,		 0},
	{ XK_Insert,			XK_ANY_MOD,			"\033[2~",			+1,		 0},
	{ XK_Delete,			CTRL,					"\033[M",			-1,		 0},
	{ XK_Delete,			CTRL,					"\033[3;5~",		+1,		 0},
